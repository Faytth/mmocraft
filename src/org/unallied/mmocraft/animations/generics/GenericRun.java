...
public class GenericRun extends GenericAnimationState {

    /**
     * 
     */
    private static final long serialVersionUID = -2354316944836742216L;
     ...
     * @param animations
     */
    public GenericRun(Living living, AnimationState last,
            Map<AnimationType, String> animations) {
        super(living, last, AnimationType.RUN, animations.get(AnimationType.RUN));
